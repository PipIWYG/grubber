...
abstract class ApiValidate
{
    ...
    public function valid($data)
    {
        ...
        if (!is_string($data))
        {
            ...
            $this->_errors[] = '\App\Libraries\ApiValidate::valid() : Non-string value passed.';
        ...
        {
            // Append error to error buffer
            $this->_errors[] = '\App\Libraries\ApiValidate::valid() : JSON is not valid. JSON ERROR: '.json_last_error();
